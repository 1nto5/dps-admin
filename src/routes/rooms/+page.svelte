...
<div class="terminal-page">
	<div class="page-header">
		...
		<div class="header-meta">
			<span class="meta-item"><span class="meta-label">total:</span><span class="meta-value">{data.rooms.length}</span></span>
			<span class="meta-divider">│</span>
			<span class="meta-item"><span class="meta-label">filtered:</span><span class="meta-value">{filteredRooms.length}</span></span>
		</div>
	</div>

	<div class="page-actions">
		<a href="/rooms/new" class="action-btn action-primary">
