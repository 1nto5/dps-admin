...
<div class="terminal-page max-w-xl">
	<div class="page-header">
		<div class="header-title">
			...
			<span class="header-text">NEW DEPARTMENT</span>
			<span class="header-decoration">────────────────────────────────────</span>
		</div>
	</div>
	...
	<div class="form-container">
		<form bind:this={formEl} onsubmit={(e) => { e.preventDefault(); handleSubmit(); }}>
			<div class="form-group">
				<label for="dept-name" class="form-label">name <span class="required">*</span></label>
<input id="dept-name" bind:value={name} class="form-input" required use:desktopAutofocus />
			</div>
